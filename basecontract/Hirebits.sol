/*
This Token Contract implements the HireBits token (beta)
.*/
...
contract HireBits is BurnableToken,Ownable { // Our token is a standard ERC20 Token with burnable and ownable aptitude
	...
	string public name = "HireBits"; //token name 
    	string public symbol = "HRBT"; // token symbol
    	uint256 public decimals = 18; // token number of decimal
    	
    	/* Public variables specific for HireBits */
        uint256 public constant MAX_SUPPLY_NBTOKEN   = 5000000*10**18; // The max cap is 5 million HireBits
	...
	function HireBits() {
		...
		dateDefrost = dateStartContract + 85 days; // everybody can defrost his own token after the 21 january 2018 }
	...
	{ // We override the transfer function to allow freeze possibility
